    ...
    return (
        <div className="about" id="about" >
            <div className="about_me">
                <h2 className="about_me_head">Hi! I'm Annukul. Nice to meet you.</h2>
                <p className="about_me_paragraph">
                    ...
                    <br />
                    I mostly do projects in the <strong className="color">MERN</strong> stacks but I have a very good knowledge of <strong className="color">PHP</strong> too.<br />
                    <br />
